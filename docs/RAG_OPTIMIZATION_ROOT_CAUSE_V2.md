...
| V2 | 查询理解 + 安全/生命周期/关系优先级编译 | 0.947619 | 100% | 100% | 100% | +0.544386 | 主要失败模式被修正（相对 V1 改变 22 条） |
...
报告的 `final_candidate_diagnostics` 进一步显示，从 V0 到终态共有 24 条 Prediction 事实发生变化，并逐题保留状态/错误码/路由对照；对应的人工解释见 [RAG_FAILURE_CASE_REVIEW_V2.md](RAG_FAILURE_CASE_REVIEW_V2.md)。
